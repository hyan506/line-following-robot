...
#define LED_1_ON          LED_1_Write(1)
#define LED_1_OFF         LED_1_Write(0)
#define LED_1_TOGGLE      LED_1_Write(~LED_1_Read())

#define LED_2_ON          LED_2_Write(1)
#define LED_2_OFF         LED_2_Write(0)
#define LED_2_TOGGLE      LED_2_Write(~LED_2_Read())
