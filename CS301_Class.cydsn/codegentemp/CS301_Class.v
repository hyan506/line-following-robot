...
// Timer_v2_70(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=1, CONTROL3=1, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeviceFamily=PSoC5, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=true, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=1, NumberOfCaptures=1, param45=1, Period=99, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=false, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=false, UsesHWEnable=0, VerilogSectionReplacementString=sT16, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=Timer_v2_70, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer_2, CY_INSTANCE_SHORT_NAME=Timer_2, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=70, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=Timer_2, )
...
module top ;
    ...
    assign Net_5240 = Net_5277 & Net_5089;
	...
	cy_clock_v1_0
		#(.id("3ea19a07-b917-433e-bc45-ee160e413b5f"),
		  .source_clock_id("315365C3-2E3E-4f04-84A2-BB564A173261"),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f27ee4f8-f2bf-4472-b462-ef1516e67cac"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("fd418f31-5101-4cf2-b967-dc84f3211534"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    assign Net_4335 = ~Net_1832;


    assign Net_4337 = ~Net_3236;


    assign Net_368 = Net_5279 & Net_5091;


    assign Net_5222 = Net_5209 & Net_5279;

    CyControlReg_v1_80 Direction_Control_2 (
        .control_1(Net_5091),
        .control_2(Net_5227),
        .control_3(Net_5228),
        .control_0(Net_5209),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Direction_Control_2.Bit0Mode = 0;
    defparam Direction_Control_2.Bit1Mode = 0;
    defparam Direction_Control_2.Bit2Mode = 0;
    defparam Direction_Control_2.Bit3Mode = 0;
    defparam Direction_Control_2.Bit4Mode = 0;
    defparam Direction_Control_2.Bit5Mode = 0;
    defparam Direction_Control_2.Bit6Mode = 0;
    defparam Direction_Control_2.Bit7Mode = 0;
    defparam Direction_Control_2.BitValue = 2;
    defparam Direction_Control_2.BusDisplay = 0;
    defparam Direction_Control_2.ExtrReset = 0;
    defparam Direction_Control_2.NumOutputs = 2;


    assign Net_362 = Net_5089 & Net_5265;

    CyControlReg_v1_80 Direction_Control_1 (
        .control_1(Net_5265),
        .control_2(Net_5267),
        .control_3(Net_5268),
        .control_0(Net_5277),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Direction_Control_1.Bit0Mode = 0;
    defparam Direction_Control_1.Bit1Mode = 0;
    defparam Direction_Control_1.Bit2Mode = 0;
    defparam Direction_Control_1.Bit3Mode = 0;
    defparam Direction_Control_1.Bit4Mode = 0;
    defparam Direction_Control_1.Bit5Mode = 0;
    defparam Direction_Control_1.Bit6Mode = 0;
    defparam Direction_Control_1.Bit7Mode = 0;
    defparam Direction_Control_1.BitValue = 1;
    defparam Direction_Control_1.BusDisplay = 0;
    defparam Direction_Control_1.ExtrReset = 0;
    defparam Direction_Control_1.NumOutputs = 2;
    ...
    assign Net_5333 = ~Net_3236;


    assign Net_5336 = ~Net_1832;
	...
	cy_psoc3_pins_v1_10
		#(.id("0ebb7cf5-091b-44b4-a04b-0548fdec00f4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("03234bfc-601e-49e1-9836-684812931fe5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__DIP0_net;
	wire [0:0] tmpFB_0__DIP0_net;
	wire [0:0] tmpIO_0__DIP0_net;
	wire [0:0] tmpINTERRUPT_0__DIP0_net;
	electrical [0:0] tmpSIOVREF__DIP0_net;

	cy_psoc3_pins_v1_10
		#(.id("97e44449-4860-46cc-b9dd-8610f7d97d3d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		DIP0
		 (.oe(tmpOE__DIP0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DIP0_net[0:0]}),
		  .analog({Net_6532}),
		  .io({tmpIO_0__DIP0_net[0:0]}),
		  .siovref(tmpSIOVREF__DIP0_net),
		  .interrupt({tmpINTERRUPT_0__DIP0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DIP0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("23b14c71-0c6a-4f06-89e6-c0bfe696ba41"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8f32acfa-f8b0-4d67-82bb-c13c20409b4d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("680c26ab-f8c9-407c-9cc5-6fe26285bed5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
